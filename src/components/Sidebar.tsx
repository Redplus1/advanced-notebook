...
import { FileText, Film, Settings, BookOpen } from "lucide-react";
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  const items: { id: Tab; key: "notes" | "projects" | "settings"; icon: React.ReactNode }[] = [
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderColor: "var(--c-border-sub)" }}
      >
        <div className="text-[10px] font-mono" style={{ color: "var(--c-text-4)" }}>v0.1.0</div>
      </div>
    </aside>
  );
};
